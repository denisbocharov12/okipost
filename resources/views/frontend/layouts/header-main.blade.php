            ...
            <div class="row">
                <div class="col-5 col-sm-4 col-md-3 col-lg-2 col-logo">
                    <div class="logo-block">
                        <a href="/">
{{--                            <img src="{{asset('frontend')}}/assets/images/logo-okipost-white.svg" id="logo-white" alt="">--}}
                            <img src="{{asset('frontend')}}/assets/images/logo-color.svg" id="logo-standart" alt="">
                        </a>
                    </div>
                </div>
                    ...
                    <nav class="nav-drill" id="nav-drill">
                        <div class="main-wrap-menu-mobile">
                            <div class="menu-close menu-mobile-account">
                                ...
                                @else
                                    <span style="margin-left: 0" class="hamburger hamburger-close" id="hamburger-close"><i class="icon-cancel"></i></span>
                                @endif
                            </div>
