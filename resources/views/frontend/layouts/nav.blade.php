        ...
        <div class="container-fluid container-nav p-5">
            <div class="row row-primary">
                <div class="col-6 col-logo">
                    <a href="/">
                        <img src="{{asset('frontend')}}/assets/images/logo-color.svg" alt="Okipost Moldova">
                    </a>
                </div>
                ...
                <div class="col-3 col-menu-nav">
                    <div class="menu-block">
                        ...
                        @if(Auth::guard('user')->check())
                            <ul class="menu-ul">
                                <li class="item"><a href="{{route('user.dashboard')}}" class="link link-color">Панель управления</a></li>
                                <li class="item"><a href="{{route('add.package')}}" class="link link-primary">Добавить посылку</a></li>
                                <li class="item"><a href="#" class="link">Оплаты</a></li>
                                <li class="item"><a href="#" class="link">Пополнения</a></li>
                                <li class="item"><a href="{{route('user.logout')}}" class="link">Выйти</a></li>
                            </ul>
                        @else
                            <ul class="menu-ul">
