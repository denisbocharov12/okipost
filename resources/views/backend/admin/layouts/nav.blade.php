    ...
    <ul class="nk-menu">
        ...
        <li class="nk-menu-item has-sub">
            ...
            <ul class="nk-menu-sub">
                <li class="nk-menu-item">
                    <a href="{{route('company.index')}}" class="nk-menu-link"><span class="nk-menu-text">Все компании</span></a>
                </li>
                <li class="nk-menu-item">
                    <a href="{{route('company.create')}}" class="nk-menu-link"><span class="nk-menu-text">Добавить компанию</span></a>
                </li>
            </ul><!-- .nk-menu-sub -->
        </li><!-- .nk-menu-item -->
        <li class="nk-menu-item">
        ...
        <li class="nk-menu-item has-sub">
            ...
            <ul class="nk-menu-sub">
                ...
                <li class="nk-menu-item">
                    <a href="#" class="nk-menu-link"><span class="nk-menu-text">User Contact - Card</span> <span class="nk-menu-badge badge-warning">New</span></a>
                </li>
            </ul><!-- .nk-menu-sub -->
        </li><!-- .nk-menu-item -->
    </ul><!-- .nk-menu -->
